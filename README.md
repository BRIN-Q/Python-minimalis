...
![Category](https://img.shields.io/badge/topic-python%20programming-blue)
...
| No. | Topik | Materi |
|---|---|---|
| 1 | 🧮 Python Dasar (sebagai Kalkulator) | [Buka PDF](notes/01-basic.pdf) |
| 2 | 🔤 Tipe Data String | [Buka PDF](notes/02-string.pdf) |
| 3 | 📋 List dan Loop | [Buka PDF](notes/03-list-loop.pdf) |
| 4 | 🔀 Kontrol Alur Program | [Buka PDF](notes/04-kontrol-alur.pdf) |
| 5 | 🧩 Fungsi/Subprogram pada Python | [Buka PDF](notes/05-fungsi.pdf) |
| 6 | 🗂️ Struktur Data Dasar | [Buka PDF](notes/06-struktur-data.pdf) |
| 7 | 📁 Masukan-Keluaran Berkas (File IO) | [Buka PDF](notes/07-file-io.pdf) |
| 8 | 📈 Larik 1D dengan NumPy | [Buka PDF](notes/08-numpy-1D.pdf) |
...
- penambahan materi,
- koreksi konsep,
- revisi dan penyuntingan tulisan,
